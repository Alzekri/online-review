<template>
  <div class="main">
      ...
      <div class="d-flex justify-content-start flex-wrap">
        <div v-for="(post, index) in currentPosts.slice(currentPosts.length - 6, currentPosts.length)" :key="post.post_id"  class="border border-dark rounded-5 m-3 p-3"
     style="width: 30%;" >
...
try {
  ...
  words.value = response.data.data.slice(-6);
} catch (error) {
